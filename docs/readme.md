...
7. [`03-ux-ui.md`](./03-ux-ui.md) — principios visuales, componentes y sistema de diseño.
8. [`04-architecture.md`](./04-architecture.md) — stack y arquitectura objetivo.
9. [`05-roadmap.md`](./05-roadmap.md) — slices verticales y Definition of Done.
10. [`06-acceptance-criteria.md`](./06-acceptance-criteria.md) — comportamiento verificable del MVP.
11. [`07-gentle-ai-workflow.md`](./07-gentle-ai-workflow.md) — uso recomendado de Opencode/Gentle-AI con SDD, ODD y RDD.
